...
public class ShoppingCartListTest {
    ...
    @Test
    public void givenNullWhenAddItemThenDoNotAddToCart() {
        shoppingCart.addItem(null);

        assertEquals(0, shoppingCart.getUniqueItems().size());
    }
    ...
    public void givenNotAddedItemWhenRemoveItemThenThrowItemNotFoundException() throws ItemNotFoundException {
        Item apple = new Apple(NAME, DESCRIPTION, PRICE);
        shoppingCart.removeItem(apple);
    }

    @Test
    public void givenAddedItemWhenRemoveItemThenRemoveSuccessfully() throws ItemNotFoundException {
        Item apple = new Apple(NAME, DESCRIPTION, PRICE);
        shoppingCart.addItem(apple);
    ...
    @Test
    public void givenThreeItemsWhenGetSortedItemsThenReturnCorrectTotalPrice() {
        final double chocolatePrice = 10;
        Item apple = new Apple(NAME, DESCRIPTION, PRICE);
        Item chocolate = new Chocolate("name2", "description2", chocolatePrice);
        shoppingCart.addItem(apple);
